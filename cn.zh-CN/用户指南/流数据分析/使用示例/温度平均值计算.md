...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/124846/156033369238938_zh-CN.png)
...
2.  添加流数据分析任务。 
    1.  参考[分配流数据分析到边缘实例](cn.zh-CN/用户指南/流数据分析/分配流数据分析到边缘实例.md#)，创建、设置并发布数据分析任务。 
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/124846/156033369238864_zh-CN.png)

    2.  在任务列表中，已创建的SQL任务名称右侧单击**查看**，进入SQL编辑器。 

        复制如下SQL内容到SQL编辑器编辑框中。

        ``` {#codeblock_wyp_19f_erj}
...
3.  添加消息路由。 
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/124846/156033369238869_zh-CN.png)
