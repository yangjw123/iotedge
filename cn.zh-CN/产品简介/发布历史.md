...
|版本号|使用环境|下载地址|发布时间|版本说明|
|:--|:---|:---|----|----|
|v1.8.4|ARMv7 VFPv3硬浮点型，Linux 要求Linux kernel version ≥ 2.6.32

 |[链接](http://link-iot-edge-packet.oss-cn-shanghai.aliyuncs.com/arm-linux-gnueabihf/link-iot-edge-lite-armv7-hf-v1.8.4.tar.gz)|2019年5月5日| -   支持按需开启/关闭远程运维通道；
-   支持远程访问被授权和转移的设备；
